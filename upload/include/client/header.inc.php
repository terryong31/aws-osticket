...
$title=($cfg && is_object($cfg) && $cfg->getTitle())
    ? $cfg->getTitle() : 'Terry Ong\'s '.__('Support Ticket System');
...
if (osTicket::is_ie())
    $ost->setWarning(__('This app no longer supports Internet Explorer.'));
?>>
<head>
    <meta charset="utf-8">
    ...
    <meta name="keywords" content="Terry's helpdesk system, Customer support system, support ticket system">
